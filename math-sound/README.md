...
![Demo](https://img.shields.io/badge/Functions-45-blue) ![Tech](https://img.shields.io/badge/Vanilla-JS-yellow) ![Audio](https://img.shields.io/badge/Web-Audio%20API-green)
...
- **45개 프리셋 함수**: 5개 카테고리로 분류
- **카테고리별 색상 구분**: 직관적인 UI
- **키보드 단축키**: Space, ←, → 지원

---

## 📐 Included Functions (45개)
